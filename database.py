...
SQLALCHEMY_DATABASE_URL = os.getenv("DATABASE_URL", "postgresql://postgres.yicilvfuyfzsbbjmnrqc:Sannidhiup%402028@aws-1-ap-northeast-1.pooler.supabase.com:6543/postgres")
